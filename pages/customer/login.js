          ...
          <div className="w-full max-w-xs">
            ...
            <form className="bg-white rounded px-8 pt-6 pb-8 mb-4">
              <div className="mb-4">
                ...
                <input
                  required
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:border-yellow-400 focus:shadow-outline"
                  id="email"
                  type="email"
                  placeholder="email..."
                />
